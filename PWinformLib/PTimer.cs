...
namespace PWinformLib
{
    public class PTimer
    {
        ...
        private static readonly List<PTimer> Subscribers = new List<PTimer>();

        private readonly Action<ulong> _callback;

        /// <summary>
        ///     Initializes a new instance of the <see cref="PTimer" /> class.
        /// </summary>
        /// <param name="callback">
        ...
        /// </param>
        public PTimer(Action<ulong> callback, FPSLimiterKnownValues fpsKnownLimit = FPSLimiterKnownValues.LimitThirty)
        ...
        ///     The max ticks per second
        /// </param>
        public PTimer(Action<ulong> callback, int fpsLimit)
        {
            if (callback == null)
            {
